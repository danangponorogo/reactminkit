                ...
                <ul className="navbar-nav navbar-align">
                    <li className="nav-item dropdown">
                        <a className="nav-icon dropdown-toggle" href="#" id="alertsDropdown" data-bs-toggle="dropdown">
                            <div className="position-relative">
                                <Icon name="bell" className="align-middle" />
                        ...
                        <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
                            ...
                            <div className="list-group">
                                ...
                                <a href="#" className="list-group-item">
                                    <div className="row g-0 align-items-center">
                                        <div className="col-2">
                                            <Icon name="user-plus" className="text-success" />
                                        </div>
                                        <div className="col-10">
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-icon dropdown-toggle" href="#" id="messagesDropdown" data-bs-toggle="dropdown">
                            <div className="position-relative">
                                <Icon name="message-square" className="align-middle" />
                            </div>
                        </a>
                    ...
                    <li className="nav-item dropdown">
                        <a className="nav-icon dropdown-toggle d-inline-block d-sm-none" href="#" data-bs-toggle="dropdown">
                            <Icon name="settings" className="align-middle" />
                        </a>

                        <a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="/adminkit/img/avatars/avatar.jpg" className="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span className="text-dark me-1">Charles Hall</span>
                        </a>
                        <div className="dropdown-menu dropdown-menu-end">
                            <a className="dropdown-item" href="pages-profile.html">
                                <Icon name="user" size={18} className="align-middle me-1" />
                                Profile</a>
                            <a className="dropdown-item" href="#">
                                <Icon name="pie-chart" size={18} className="align-middle me-1" />
                                Analytics</a>
                            <div className="dropdown-divider"></div>
                            <a className="dropdown-item" href="index.html">
                                <Icon name="settings" size={18} className="align-middle me-1" />
                                Settings & Privacy</a>
                            <a className="dropdown-item" href="#">
                                <Icon name="help-circle" size={18} className="align-middle me-1" />
                                Help Center</a>
                            <div className="dropdown-divider"></div>
